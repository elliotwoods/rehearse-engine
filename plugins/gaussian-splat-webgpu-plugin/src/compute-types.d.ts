...
declare module "three/tsl" {
  ...
  // AtomicFunctionNode exports (re-exported by TSL.js)
  export function atomicFunc(method: string, pointer: any, value: any, store?: any): any;
  export function atomicAdd(pointer: any, value: any, store?: any): any;
  export function atomicMax(pointer: any, value: any, store?: any): any;
  export function atomicMin(pointer: any, value: any, store?: any): any;
  export function atomicStore(pointer: any, value: any, store?: any): any;

  // LoopNode exports (re-exported by TSL.js)
  export function Loop(count: any, fn: (args: { i: any }) => void): any;
  export function Break(): any;
  export function Continue(): any;

  // IndexNode exports (re-exported by TSL.js)

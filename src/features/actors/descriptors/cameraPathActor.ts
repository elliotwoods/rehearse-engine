...
import { getCameraPathDurationSeconds, getCameraPathKeyframeCount } from "@/features/cameraPath/model";
  ...
  status: {
    build({ actor, state }) {
      ...
      return [
        ...
        { label: "Keyframes", value: getCameraPathKeyframeCount(actor, state.actors) },
        { label: "Duration (s)", value: getCameraPathDurationSeconds(actor, state.actors) },
